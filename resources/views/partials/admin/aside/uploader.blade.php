	...
	<section class="sidebar">
		...
		<div class="user-panel">
			<div class="pull-left image">
				<img src="image/admin/user-uploader.jpg" class="img-circle" alt="User Image">
			</div>
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="treeview links-comment">
				...
				<ul class="treeview-menu">
					...
					<li><a href="#" class="box-link" data-target="#box-book-detail" data-with="#box-book-list-small">Chi tiết truyện</a></li>
