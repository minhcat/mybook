...
<div class="box box-primary collapse character-edit" id="box-edit-character-{{ $character->id }}" aria-expanded="false">
	...
	<form id="create-character-{{ $character->id }}" action="{{ url('/admin/uploader/update_character/'.$character->id) }}" method="POST" enctype="multipart/form-data">
		<div class="box-body">
			...
			<div class="box-edit">
				...
				<div class="form-group">
					...
					<input type="text" name="family" class="form-control" placeholder="tên thành viên" value="{{ $character->family }}">
				</div>
				<div class="form-group">
					<label for="name">Nghề nghiệp</label>
					<input type="text" name="job" class="form-control" placeholder="tên thành viên" value="{{ $character->job }}">
				</div>
				<div class="form-group">
					<label for="name">Sở thích</label>
					<input type="text" name="hobby" class="form-control" placeholder="tên thành viên" value="{{ $character->hobby }}">
				</div>
				<div class="form-group">
