	...
	<section class="content container-fluid">
		...
		<div class="row">
			<div class="col-xs-12">
					...
					<div class="box-body">
						...
						<div class="direct-chat-messages">
							...
							<div class="direct-chat-msg">
								...
								Lorem ipsum dolor sit amet, consectetuer adipiscing elit
								<hr>
								Nội dung báo cáo: Spam - Nguyễn Bình Nguyên
								</div>
								<!-- tag comment -->
							...
							<div class="direct-chat-msg">
								...
								Sed diam nonummy nibh euismod
								<hr>
								Nội dung báo cáo: Quảng cáo - Nhật Hoa
								</div>
								<!-- /.direct-chat-text -->
								<!-- tag comment -->
								<div class="direct-chat-button mt-15">
							...
							<div class="direct-chat-msg">
								...
								<!-- /.direct-chat-info -->
								<img class="direct-chat-img" src="img/user4-128x128.jpg" alt="Message User Image">
								<!-- /.direct-chat-img -->
								<div class="direct-chat-text">
								tincidunt ut laoreet dolore magna aliquam erat volutpat.
								<hr>
								Nội dung báo cáo: Nói tục, chửi thề - Phạm Tiến
								</div>
								<!-- tag comment -->
								<div class="direct-chat-button mt-15">
									<span class="fa fa-plus bg-blue" title="thêm vào danh sách kiểm tra" data-toggle="modal" data-target="#modal-comment-save"></span>
							...
							<div class="direct-chat-msg">
								...
								<!-- /.direct-chat-info -->
								<img class="direct-chat-img" src="img/user5-128x128.jpg" alt="Message User Image">
								<!-- /.direct-chat-img -->
								<div class="direct-chat-text">
								Ut wisi enim ad minim veniam.
								<hr>
								Nội dung báo cáo: Bình luận liên quan đến chính trị, kinh tế, tôn giáo - Quang Lê
								</div>
								<!-- /.direct-chat-text -->
								<!-- tag comment -->
								<div class="direct-chat-button mt-15">
				...
				<div class="box box-primary direct-chat direct-chat-primary collapse" id="box-comment-autocheck" aria-expanded="false">
					<!-- box header -->
					<div class="box-header with-border">
						<h3 class="box-title">Bình Luận Kiểm Tra Tự Động</h3>
					...
					<div class="box-body">
						...
						<div class="direct-chat-messages">
							...
							<div class="direct-chat-msg">
								...
								<!-- /.direct-chat-img -->
								<div class="direct-chat-text">
								<strong>Sed</strong> diam nonummy nibh euismod
								</div>
								<!-- /.direct-chat-text -->
								<!-- tag comment -->
								<div class="direct-chat-button">
							...
							<div class="direct-chat-msg">
								...
								<!-- /.direct-chat-img -->
								<div class="direct-chat-text">
								tincidunt ut laoreet <strong>dolore</strong> magna aliquam erat <strong>volutpat</strong>.
								</div>
								<!-- tag comment -->
								<div class="direct-chat-button">
									<span class="fa fa-plus bg-blue" title="thêm vào danh sách kiểm tra" data-toggle="modal" data-target="#modal-comment-save"></span>
							...
							<div class="direct-chat-msg">
								...
								<!-- /.direct-chat-img -->
								<div class="direct-chat-text">
								Ut wisi enim ad minim <strong>veniam</strong>.
								</div>
								<!-- /.direct-chat-text -->
								<!-- tag comment -->
								<div class="direct-chat-button">
			...
			<div class="col-xs-9">
				<div class="box box-primary direct-chat direct-chat-primary collapse" id="box-book-comment" aria-expanded="false" data-with="#box-book-follow-small">
					<!-- box header -->
					<div class="box-header with-border">
						<h3 class="box-title">Bình Luận Trên Truyện Black Clover</h3>
