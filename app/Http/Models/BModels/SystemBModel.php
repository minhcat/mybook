...
class SystemBModel extends Model
{
	...
	public static function get_variables_super_admin() {
		...
		$list_2                  = SystemQModel::get_variable_by_name('list_2');
		$list_3                  = SystemQModel::get_variable_by_name('list_3');
		$list_4                  = SystemQModel::get_variable_by_name('list_4');
		$list_title_1            = SystemQModel::get_variable_by_name('list_title_1');
		$list_title_2            = SystemQModel::get_variable_by_name('list_title_2');
		$list_title_3            = SystemQModel::get_variable_by_name('list_title_3');
		$list_title_4            = SystemQModel::get_variable_by_name('list_title_4');
		$list_info_1             = SystemQModel::get_variable_by_name('list_info_1');
		$list_info_2             = SystemQModel::get_variable_by_name('list_info_2');
		$list_info_3             = SystemQModel::get_variable_by_name('list_info_3');
		$list_info_4             = SystemQModel::get_variable_by_name('list_info_4');
		$list_type_1             = SystemQModel::get_variable_by_name('list_type_1');
		$list_type_2             = SystemQModel::get_variable_by_name('list_type_2');
		$list_type_3             = SystemQModel::get_variable_by_name('list_type_3');
		$list_type_4             = SystemQModel::get_variable_by_name('list_type_4');
		$list_number_1           = SystemQModel::get_variable_by_name('list_number_1');
		$list_number_2           = SystemQModel::get_variable_by_name('list_number_2');
		$list_number_3           = SystemQModel::get_variable_by_name('list_number_3');
		$list_number_4           = SystemQModel::get_variable_by_name('list_number_4');
		...
		// detail system
		$detail_1                = SystemQModel::get_variable_by_name('detail_1');
		$detail_2                = SystemQModel::get_variable_by_name('detail_2');
		$detail_3                = SystemQModel::get_variable_by_name('detail_3');
		$detail_4                = SystemQModel::get_variable_by_name('detail_4');
		$detail_5                = SystemQModel::get_variable_by_name('detail_5');
		$detail_title_1          = SystemQModel::get_variable_by_name('detail_title_1');
		$detail_title_2          = SystemQModel::get_variable_by_name('detail_title_2');
		$detail_title_3          = SystemQModel::get_variable_by_name('detail_title_3');
		$detail_title_4          = SystemQModel::get_variable_by_name('detail_title_4');
		$detail_title_5          = SystemQModel::get_variable_by_name('detail_title_5');
		$detail_info_1           = SystemQModel::get_variable_by_name('detail_info_1');
		$detail_info_2           = SystemQModel::get_variable_by_name('detail_info_2');
		$detail_info_3           = SystemQModel::get_variable_by_name('detail_info_3');
		$detail_info_4           = SystemQModel::get_variable_by_name('detail_info_4');
		$detail_info_5           = SystemQModel::get_variable_by_name('detail_info_5');
		$detail_type_1           = SystemQModel::get_variable_by_name('detail_type_1');
		$detail_type_2           = SystemQModel::get_variable_by_name('detail_type_2');
		$detail_type_3           = SystemQModel::get_variable_by_name('detail_type_3');
		$detail_type_4           = SystemQModel::get_variable_by_name('detail_type_4');
		$detail_type_5           = SystemQModel::get_variable_by_name('detail_type_5');
		$detail_comment          = SystemQModel::get_variable_by_name('detail_comment');
		$detail_comment_add      = SystemQModel::get_variable_by_name('detail_comment_add');
		$detail_comment_reply    = SystemQModel::get_variable_by_name('detail_comment_reply');
		$detail_sidebar          = SystemQModel::get_variable_by_name('detail_sidebar');
		$detail_sidebar_box_1    = SystemQModel::get_variable_by_name('detail_sidebar_box_1');
		$detail_sidebar_box_2    = SystemQModel::get_variable_by_name('detail_sidebar_box_2');
		$detail_sidebar_box_3    = SystemQModel::get_variable_by_name('detail_sidebar_box_3');
		$detail_sidebar_box_4    = SystemQModel::get_variable_by_name('detail_sidebar_box_4');
		$detail_sidebar_box_5    = SystemQModel::get_variable_by_name('detail_sidebar_box_5');
		$detail_sidebar_box_6    = SystemQModel::get_variable_by_name('detail_sidebar_box_6');
		$detail_sidebar_number_1 = SystemQModel::get_variable_by_name('detail_sidebar_number_1');
		$detail_sidebar_number_2 = SystemQModel::get_variable_by_name('detail_sidebar_number_2');
		$detail_sidebar_number_3 = SystemQModel::get_variable_by_name('detail_sidebar_number_3');
		$detail_sidebar_number_4 = SystemQModel::get_variable_by_name('detail_sidebar_number_4');
		$detail_sidebar_number_5 = SystemQModel::get_variable_by_name('detail_sidebar_number_5');
		$detail_sidebar_number_6 = SystemQModel::get_variable_by_name('detail_sidebar_number_6');
		...
		$data['list_2']                  = $list_2->value;
		$data['list_3']                  = $list_3->value;
		$data['list_4']                  = $list_4->value;
		$data['list_title_1']            = $list_title_1->value;
		$data['list_title_2']            = $list_title_2->value;
		$data['list_title_3']            = $list_title_3->value;
		$data['list_title_4']            = $list_title_4->value;
		$data['list_info_1']             = $list_info_1->value;
		$data['list_info_2']             = $list_info_2->value;
		$data['list_info_3']             = $list_info_3->value;
		$data['list_info_4']             = $list_info_4->value;
		$data['list_type_1']             = $list_type_1->value;
		$data['list_type_2']             = $list_type_2->value;
		$data['list_type_3']             = $list_type_3->value;
		$data['list_type_4']             = $list_type_4->value;
		$data['list_number_1']           = $list_number_1->value;
		$data['list_number_2']           = $list_number_2->value;
		$data['list_number_3']           = $list_number_3->value;
		$data['list_number_4']           = $list_number_4->value;
		...
		// detail system
		$data['detail_1']                = $detail_1->value;
		$data['detail_2']                = $detail_2->value;
		$data['detail_3']                = $detail_3->value;
		$data['detail_4']                = $detail_4->value;
		$data['detail_5']                = $detail_5->value;
		$data['detail_title_1']          = $detail_title_1->value;
		$data['detail_title_2']          = $detail_title_2->value;
		$data['detail_title_3']          = $detail_title_3->value;
		$data['detail_title_4']          = $detail_title_4->value;
		$data['detail_title_5']          = $detail_title_5->value;
		$data['detail_info_1']           = $detail_info_1->value;
		$data['detail_info_2']           = $detail_info_2->value;
		$data['detail_info_3']           = $detail_info_3->value;
		$data['detail_info_4']           = $detail_info_4->value;
		$data['detail_info_5']           = $detail_info_5->value;
		$data['detail_type_1']           = $detail_type_1->value;
		$data['detail_type_2']           = $detail_type_2->value;
		$data['detail_type_3']           = $detail_type_3->value;
		$data['detail_type_4']           = $detail_type_4->value;
		$data['detail_type_5']           = $detail_type_5->value;
		$data['detail_comment']          = $detail_comment->value;
		$data['detail_comment_add']      = $detail_comment_add->value;
		$data['detail_comment_reply']    = $detail_comment_reply->value;
		$data['detail_sidebar']          = $detail_sidebar->value;
		$data['detail_sidebar_box_1']    = $detail_sidebar_box_1->value;
		$data['detail_sidebar_box_2']    = $detail_sidebar_box_2->value;
		$data['detail_sidebar_box_3']    = $detail_sidebar_box_3->value;
		$data['detail_sidebar_box_4']    = $detail_sidebar_box_4->value;
		$data['detail_sidebar_box_5']    = $detail_sidebar_box_5->value;
		$data['detail_sidebar_box_6']    = $detail_sidebar_box_6->value;
		$data['detail_sidebar_number_1'] = $detail_sidebar_number_1->value;
		$data['detail_sidebar_number_2'] = $detail_sidebar_number_2->value;
		$data['detail_sidebar_number_3'] = $detail_sidebar_number_3->value;
		$data['detail_sidebar_number_4'] = $detail_sidebar_number_4->value;
		$data['detail_sidebar_number_5'] = $detail_sidebar_number_5->value;
		$data['detail_sidebar_number_6'] = $detail_sidebar_number_6->value;
	 ...
	 * @return object|boolean : all properties from `books` table
	 */
	public static function get_variables_website() {
		$website_name            = SystemQModel::get_variable_by_name('website_name');
		$slogan                  = SystemQModel::get_variable_by_name('slogan');
		$logo                    = SystemQModel::get_variable_by_name('logo');
		$header_image_1          = SystemQModel::get_variable_by_name('header_image_1');
